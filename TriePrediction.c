...
//--------------------------------------------
// Frees all memory associated with Trie
...
void getMostFrequentWordHelper(TrieNode *root, char *temp, char *str, int k, int max, int *cnt)
{
	...
	// Finds first word alphabetically with maximum count in trie
...
//--------------------------------------------
// Returns pointer to the terminal node of a string,
// If the string is in the trie
...
//--------------------------------------------
// Executes commands <string>, @ <string> n, and ! in an input file
